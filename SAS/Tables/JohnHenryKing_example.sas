...
%let avars = sex race ag ageg _page_ bmi height weight;  
%let rowofn = yes; 
...
ods listing close; ods ESCAPECHAR = '!'; ods rtf file="&path.rtf" style=statsinrows;
...
endcomp;    
compute before vlabel / style=[just=left];       blankline = ' ';
if f eq 0 then do;
	l1 = 0;         
	f  = 1;         
	end;       
